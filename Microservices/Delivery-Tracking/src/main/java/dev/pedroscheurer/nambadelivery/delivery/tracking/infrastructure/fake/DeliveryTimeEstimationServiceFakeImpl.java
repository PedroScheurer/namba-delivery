package dev.pedroscheurer.nambadelivery.delivery.tracking.infrastructure.fake;

import dev.pedroscheurer.nambadelivery.delivery.tracking.domain.model.ContactPoint;
import dev.pedroscheurer.nambadelivery.delivery.tracking.domain.service.DeliveryEstimate;
import dev.pedroscheurer.nambadelivery.delivery.tracking.domain.service.DeliveryTimeEstimationService;
