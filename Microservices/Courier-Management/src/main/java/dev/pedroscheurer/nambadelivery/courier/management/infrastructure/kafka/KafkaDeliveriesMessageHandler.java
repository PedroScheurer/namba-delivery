package dev.pedroscheurer.nambadelivery.courier.management.infrastructure.kafka;

import dev.pedroscheurer.nambadelivery.courier.management.domain.service.CourierDeliveryService;
import dev.pedroscheurer.nambadelivery.courier.management.infrastructure.event.DeliveryFulfilledIntegrationEvent;
import dev.pedroscheurer.nambadelivery.courier.management.infrastructure.event.DeliveryPlacedIntegrationEvent;
